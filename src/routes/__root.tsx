  ...
  head: () => ({
    meta: [
      ...
      { title: "Stock Portfolio Tracker" },
      {
        name: "description",
        content:
          "A fintech-style dashboard to track stock holdings, allocation and total investment using demo prices.",
      },
      { property: "og:title", content: "Stock Portfolio Tracker" },
      {
        property: "og:description",
        content:
          "Track holdings, allocation charts and transaction history with demo stock prices.",
      },
